...
DEFAULT_CACHE_ROOT = Path(os.environ.get("CACHE_ROOT", os.environ.get("PROPAGATOR_CACHE_DIR", "/mnt/data/cache")))
DEFAULT_TRAIN_META = DEFAULT_CACHE_ROOT / "propagator_train_0bdf721e35.meta.json"
DEFAULT_VAL_META = DEFAULT_CACHE_ROOT / "propagator_val_2870bd9dbf.meta.json"
